...
class ColourChaser(Node):
    ...
    def camera_callback(self, data):
        ...
        # lowermask = cv2.inRange(current_frame_hsv, lower1, upper1)
        # uppermask = cv2.inRange(current_frame_hsv, lower2, upper2)
        ...
        # print(lowermask)
        current_frame_mask = cv2.inRange(current_frame_hsv, lower1, upper1) # orange
